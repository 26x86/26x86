...
Support is evidence-based and can differ by macOS release, GPU, firmware, and
installed upgrades. A model listed here is a documentation target, not a
promise of complete runtime support.

## Model families

| Family | Starting document | Main risks |
| --- | --- | --- |
