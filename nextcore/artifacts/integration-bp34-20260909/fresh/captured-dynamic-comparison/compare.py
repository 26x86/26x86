...
def compare(case,actual,ram,expected_ram):
 ...
 if not success:
  ...
  checks["native_unsupported_bookkeeping"]=(cpu[36],cpu[37],cpu[38],cpu[39],cpu[46],r["guest_far"])==(0,0,va+40,0x3c5,1,0)
...
def main():
 ...
 result={"schema":"nextcore.bp34-captured-arm-native-dynamic-comparison.v1","passed":passed,"case_count":6,"cases":cases,
    ...
    "hvc_supported":False,"hvc_boundary":"Original HVC0x34 remains at codeVA+40. Compare guaranteed post-ISB effects before it. Native status8/undefined with ELR at HVC and SPSR3c5 is separately asserted diagnostic policy, not equality to the actual Arm HVC-to-EL2 completion state; HVC is not retired by native.",
