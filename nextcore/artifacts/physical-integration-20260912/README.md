# Physical-target boot continuation: first integration checkpoint
...
- Connect published UBFM and new complete extended-register ADD/SUB arithmetic.
  Core bab7ac4, Tool 8ea73c8, ISE 0f69e76 and EFI 2aef036 identify this checkpoint.
...
and provider status zero. Raw original coordinates, instructions, logs and copies
...
The next execution work is standard conditional-selection instruction support,
