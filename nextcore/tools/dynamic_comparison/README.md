...
The active exact runtime is ISE `3a0ed3dd39f78fc3c55415f898d7faa8f34699c2`,
including transactional rejection of unsupported TCR controls,
baseline hierarchical table permissions, coherent MMFR0 reads and
...
`VALIDATION_OPTIONAL_TCR_20260913.md` and `evidence-optional-tcr-20260913`.
The preceding hierarchy sources remain under `history/778473f`,
with `evidence-hierarchy-20260913` unchanged.
...
`evidence-isar0-20260913` unchanged.
