...
#[path="@RUNTIME@/preos/src/platform.rs"]mod platform;
#[path="@RUNTIME@/memory_boot.rs"]mod memory_boot;
#[path="@RUNTIME@/memory_boot_v2.rs"]mod memory_boot_v2;
#[path="@RUNTIME@/memory_dynamic.rs"]mod memory_dynamic;
